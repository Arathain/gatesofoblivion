...
public class BoundFollowBinderGoal<T extends HostileEntity & BoundEntity> extends Goal {
    ...
    public BoundFollowBinderGoal(T tameable, double speed, float minDistance, float maxDistance, boolean leavesAllowed) {

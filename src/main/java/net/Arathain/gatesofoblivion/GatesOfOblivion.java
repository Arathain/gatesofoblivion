...
public class GatesOfOblivion implements ModInitializer {
    ...
    public static final Item RANNA = new Item( new Item.Settings().group(ItemGroup.TOOLS));
    ...
    public static final Item ASTARAEL = new Item( new Item.Settings().group(ItemGroup.TOOLS));
